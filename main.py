...
ttk.Button(text='-', command=lambda: enter_number('-')).grid(row=4, column=2)
ttk.Button(text='*', command=lambda: enter_number('*')).grid(row=5, column=0)
ttk.Button(text='/', command=lambda: enter_number('/')).grid(row=5, column=1)
ttk.Button(text='x²', command=lambda: enter_number('')).grid(row=5, column=2)
ttk.Button(text='x³', command=lambda: enter_number('')).grid(row=6, column=0)
ttk.Button(text='C', command=lambda: clear_entry()).grid(row=6, column=1)
ttk.Button(text='=', command=lambda: enter_number('=')).grid(row=6, column=2)
